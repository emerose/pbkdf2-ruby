...
describe PBKDF2, 'when deriving keys' do
  ...
  it 'should match the first test case in appendix B of RFC 3962' do
    ...
    p = PBKDF2.new do |pb|
      pb.hash_function = :sha1
      pb.iterations = 1
      pb.password = 'password'
      pb.salt = 'ATHENA.MIT.EDUraeburn'
      pb.key_length = 128 / 8
    end
  ...
  it 'should match the fourth test case in appendix B of RFC 3962' do
    ...
    p = PBKDF2.new do |pb|
      ...
      pb.iterations = 5
      pb.password = 'password'
      pb.salt = [0x1234567878563412].pack('Q')
      pb.key_length = 128 / 8
    end
  ...
  it 'should match the fifth test case in appendix B of RFC 3962' do
    ...
    p = PBKDF2.new do |pb|
      pb.hash_function = :sha1
      pb.iterations = 1200
      pb.password = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
      pb.salt = 'pass phrase equals block size'
      pb.key_length = 128 / 8
    end
  ...
  it 'should match the sixth test case in appendix B of RFC 3962' do
    ...
    p = PBKDF2.new do |pb|
      pb.hash_function = :sha1
      pb.iterations = 1200
      pb.password = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
      pb.salt = 'pass phrase exceeds block size'
      pb.key_length = 128 / 8
    end
  ...
  it 'should match the seventh test case in appendix B of RFC 3962' do
    ...
    p = PBKDF2.new do |pb|
      ...
      pb.password = [0xf09d849e].pack('N')
      pb.salt = 'EXAMPLE.COMpianist'
      pb.key_length = 128 / 8
    end
